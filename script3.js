...
const COLOR = {
  Red:    '#FFD700', // Dorado brillante
  Green:  '#FDB813', // Amarillo oro
  Blue:   '#fbff00', // Amarillo limón (el que tenías)
  Purple: '#FFFACD', // Amarillo crema (casi blanco)
  Gold:   '#FFBF36', // Naranja-dorado (el que tenías)
  White:  '#FFFFFF'  // Blanco puro para destellos
};
